...
function addNewStage() {
    ...
    document.getElementById('stages').innerHTML +=
        ...
        '</div >' +
        '<input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value = '+ counter +' disabled="disabled" id="stages-input-' + counter + '">' +
        '</div>' +
        ...
        '</div>' +
        '<input type="date" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" id="time-input-' + counter + '">' +
        '</div>' +
        ...
        '</div>' +
        '<input type="float" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" id="amount-input-' + counter + '">' +
        '</div>' +
        '</div> '
}
